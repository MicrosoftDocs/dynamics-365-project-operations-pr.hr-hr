...
description: Ovaj članak pruža informacije o obradi optičkog prepoznavanja znakova (OCR) za potvrde. Ova je značajka osmišljena kako bi poboljšala korisničko iskustvo kada se izvješća o troškovima kreiraju u Microsoft Dynamics 365 Finance.
author: stsporen
ms.date: 05/14/2020
ms.topic: article
ms.prod: ''
