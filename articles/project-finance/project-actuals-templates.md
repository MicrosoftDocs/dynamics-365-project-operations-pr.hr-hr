...
- Ako stvarate novi predložak, morate dodati stupac za podršku vremenu i izdacima unutar tvrtke. Odaberite **Dodaj uvjetni stupac** i unesite naziv novog stupca, kao što je **LegalEntity**. Unesite uvjet za stupac, gdje, if **msdyn\_contractorganizationalunitid.msdyn\_name** is \<organizational unit\>, then \<enter the legal entity\>; else null.
...
[![Mapiranje predloška](./media/ActualsMapping.jpg)](./media/ActualsMapping.jpg)

[![Mapiranje predloška](./media/TransactionConnections.jpg)](./media/TransactionConnections.jpg)
...
[![Mapiranje predloška](./media/ActualsUpdateMapping.jpg)](./media/ActualsUpdateMapping.jpg)

[![Mapiranje predloška](./media/TransactionConnectionsUpdate.jpg)](./media/TransactionConnectionsUpdate.jpg)
