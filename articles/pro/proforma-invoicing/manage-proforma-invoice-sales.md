...
### <a name="create-new-invoice-line-details"></a>Stvaranje nove pojedinosti retka fakture

Na redcima fakture za vrijeme i materijal možete stvoriti nove pojedinosti retka fakture. Ove pojedinosti retka fakture nemaju potporu u stvarnom podatku. U retku fakture za materijal i vrijeme možete odabrati **Novo** za stvaranje nove pojedinosti retka fakture za klase transakcija koje su uključene u redak ugovora.
...
## <a name="product-based-invoice-lines"></a>Redci fakture koji se temelje na proizvodu
