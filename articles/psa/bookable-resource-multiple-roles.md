...
description: U ovom se članku navode informacije o tome kako se dimenzije određivanja cijena mogu koristiti za podršku određivanju cijena i troškovima resursa koji ispunjava više uloga u projektu.
author: rumant
ms.custom:
