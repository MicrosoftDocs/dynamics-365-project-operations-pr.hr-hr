...
4. Ako za korisnika niste odabrali Spencera Lowa s korisničkim imenom **spencerl**, morate ažurirati dodatnu datoteku. Otvorite datoteku **DemoDataPreImportConfig.xml**, a zatim pronađite oznaku **userstocreateandconfigure**. Ažurirajte oznaku **\<login\>** korisničkim imenom korisnika Spencera Lowa. Dodatne pojedinosti potražite u [tehničkim napomenama](#technical-notes).
...
4. Ako vaš korisnik s imenom i prezimenom „Spencer Low” ima drugačiji korisnički ID od **"spencerl**, morate ažurirati dodatnu datoteku. Otvorite datoteku **DemoDataPreImportConfig.xml** pa pronađite oznaku **userstocreateandconfigure**. Ažurirajte oznaku **\<prijava\>** varijablom loginId (razlikovanje velikih i malih slova). 
...
- **\<RequiredSolutions\>** navodi potrebne instalacije rješenja i njihove brojeve verzija.
...
- **\<EntitiesToEnableScheduling\>** određuje koje bi entitete trebalo omogućiti za rezervaciju u stavci Planiranje sustava Microsoft Dynamics (također poznato kao Universal Resource Scheduling).
