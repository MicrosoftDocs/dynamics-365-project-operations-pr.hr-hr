...
Zbog toga postoje dvije vrste vrijednosti dimenzija cijena dostupnih u sustavu Project Service Automation (PSA): 
...
- [Postavljanje prilagođenih polja kao dimenzija cijena](set-up-pricing-dimensions.md)
