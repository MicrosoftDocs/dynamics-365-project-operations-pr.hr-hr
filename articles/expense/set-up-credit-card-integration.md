...
description: U ovom se članku objašnjava način rada s transakcijama kreditnih kartica povezanih s troškovima.
author: suvaidya
ms.date: 11/17/2021
ms.topic: article
ms.prod: ''
...
Ponekad, nakon uvoza transakcija kreditnom karticom, određene transakcije možda će trebati izbrisati. To je možda potrebno učiniti zato što su transakcije duplikati ili zato što podaci nisu točni. Administratori mogu upotrebljavati značajku **„Brisanje transakcija kreditnom karticom”** za odabir i brisanje transakcija kreditnom karticom koje **nisu priložene** izvješću o troškovima. 
...
## <a name="storing-credit-card-numbers"></a>Pohrana brojeva kreditnih kartica

Dostupne su tri opcije za pohranjivanje brojeva kreditnih kartica. Brojevi kreditnih kartica pohranjuju se na stranici **Parametri upravljanja troškovima**.

- **Spriječi unos brojeva kartice** – Brojevi kreditnih kartica ne pohranjuju se.
- **Šifriraj brojeve kartica (pohrani posljednje četiri znamenke)** – Posljednje četiri znamenke brojeva kreditnih kartica pohranjuju se u šifriranom formatu.
- **Pohrani brojeve kartica** – Brojevi kreditnih kartica pohranjuju se u nešifriranom formatu. Ova opcija nije u skladu sa Standardom sigurnosti podataka (DSS) Industrije platnih kartica (PCI). Stoga bi administratori trebali odabrati da ne pohranjuju brojeve kreditnih kartica ili da pohranjuju šifrirane brojeve kartica kako bi njihova organizacija bila usklađena s PCI DSS propisima.
