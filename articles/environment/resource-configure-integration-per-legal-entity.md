...
description: U ovom članku nalaze se informacije o postavljanju integracije po pravnoj osobi u aplikaciji Project Operations.
author: sigitac
ms.date: 10/21/2020
ms.topic: article
...
U ovom članku prolazite korake potrebne za konfiguriranje aplikacije Dynamics 365 Project Operations po pravnoj osobi.

## <a name="enable-feature-keys-in-dynamics-365-finance"></a>Omogućivanje ključeva značajki u aplikaciji Dynamics 365 Finance
...
2. U mogućnosti **Popis značajki** pronađite i omogućite sljedeće značajke:
    ...
    - **Omogućite Project Operations na Dynamics 365 Customer Engagement**
